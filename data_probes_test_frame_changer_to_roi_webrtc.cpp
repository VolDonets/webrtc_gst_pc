...
#define STR_ROI_WIDTH "320"
#define STR_ROI_HEIGHT "240"
#define STR_ROI_X_GET "10"
#define STR_ROI_Y_GET "10"
...
create_receiver_entry (SoupWebsocketConnection * connection)
{
    ...
    receiver_entry->pipeline =
            gst_parse_launch ("webrtcbin name=webrtcbin  stun-server=stun://" STUN_SERVER " caps=\"application/x-rtp,media=video,encoding-name=H264,payload=" RTP_PAYLOAD_TYPE ",width=" STR_ROI_WIDTH ",height=" STR_ROI_HEIGHT ",framerate=" STR_FRAMERATE "\" "
